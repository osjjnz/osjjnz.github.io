...
$.device = (/phone|android|webos|iphone|ipad|ipod|blackberry|iemobile|opera mini/i.test(navigator.userAgent.toLowerCase()));
...
(function ($) {
    ...
    $.fn.youtube_background = function() {
        ...
        function onVideoPlayerReady(event) {
            ...
            // dont play video if on low bandwidth connection
            if ($.device || Modernizr.lowbandwidth) {
                return;
            }
            ...
            setTimeout(function(){
                // hide poster
                var postClass = $this.data("poster-class");
                var postClassElement = $(postClass);
                postClassElement.fadeOut(1000);
            }, 1000);
        }
